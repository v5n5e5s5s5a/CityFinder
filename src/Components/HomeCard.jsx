...
export const HomeCard = ({countryImage, onPressCountry}) => {
    return (
        <TouchableOpacity style={{ display: 'flex', flexDirection: 'row', backgroundColor: 'transparent', width: '100%', height: 60, alignItems: 'center', gap: 15,}} onPress={onPressCountry} >
